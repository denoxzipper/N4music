...
from N4.N4Utilities.database.playlist import get_note_names, get_playlist, delete_playlist
from N4.N4Utilities.helpers.inline import confirm_keyboard, play_list_keyboard, confirm_group_keyboard
...
@Client.on_message(command(["delmyplaylist", "delmyplaylist@n4music_bot"]) & other_filters)
...
@Client.on_message(command(["delchatplaylist", "delchatplaylist@n4music_bot"]) & other_filters)
