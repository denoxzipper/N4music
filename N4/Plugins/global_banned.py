from N4 import app, SUDOERS, BOT_ID, OWNER
from N4.N4Utilities.database.gbanned import (get_gbans_count, is_gbanned_user, add_gban_user, add_gban_user, remove_gban_user)
from N4.N4Utilities.database.sudo import (get_sudoers, add_sudo, remove_sudo)
        ...
        if user.id == from_user.id:
            ...
            for sex in served_chats:
                try:
                    ...
                    pass    
            ban_text = f"""
🚷 **new global ban on N4 Music Bot**
...
async def chat_watcher_func(_, message):
    ...
    if await is_gbanned_user(userid):
        try:
            ...
            return       
        await message.reply_text(f"{checking} is globally banned by N4 Music Bot and has been kicked out from chat.\n\n🚫 **reason:** potential spammer and abuser.")
